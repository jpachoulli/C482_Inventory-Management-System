...
import jbernsd_IMS.Model.InHouse;
import jbernsd_IMS.Model.Inventory;
import jbernsd_IMS.Model.Outsourced;
import jbernsd_IMS.Model.Part;
import jbernsd_IMS.Model.Product;
import jbernsd_IMS.View.AddPartController;
import jbernsd_IMS.View.AddProductController;
import jbernsd_IMS.View.MainScreenController;
import jbernsd_IMS.View.ModifyPartController;
import jbernsd_IMS.View.ModifyProductController;
...
// The rool layout, as well as the rest of the screens, are configued
// to load here, and passed to their respective controllers.
//
// This MainApp class must be referenced here, as well as in the other screens,
...
//        Inventory.getProducts().addAll(sampleProductData);
    ...
    */
    public boolean showModPartScreen() {
        ...
        // Set ModifyPartScreen as MainApp.
        controller01.setMainApp(this);
        // Create the dialogue stage.
        Stage dialogueStage = new Stage();
        ...
        // Sets the stage for controller02.
        controller02.setDialogueStage(dialogueStage);
        // Sets ModifyPartScreen as MainApp.
        controller02.setMainApp(this);
        // Show the stage and wait for user input.
        dialogueStage.showAndWait();
        // return true if the save button is clicked.
    ...
    */    
    public boolean showAddProductScreen() {
       ...
       try {            
            ...
            // Set AddProductScreen as MainApp.
            controller01.setMainApp(this);
            // Create the dialogue stage.
            Stage dialogueStage = new Stage();
            // Set the stage title.
            ...
            // Sets AddProductScreen as MainApp.
            controller02.setMainApp(this);
            // Show the stage and wait for user input.
            dialogueStage.showAndWait();
            // return true if the save button is clicked.
    ...
    */
    public boolean showModProductScreen() {
        ...
        // Set ModifyProductScreen as MainApp.
        controller01.setMainApp(this);
        // Create the dialogue stage.
        Stage dialogueStage = new Stage();
        // Set the stage title.
        ...
        // Sets the stage for controller02.
        controller02.setDialogueStage(dialogueStage);
        // Sets ModifyProductScreen as MainApp.
        controller02.setMainApp(this);
        // Show the stage and wait for user input.
        dialogueStage.showAndWait();
        // return true if the save button is clicked.
